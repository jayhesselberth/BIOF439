...
ggplot(
  ...
  aes(x = NBC,
      y = FCB,
      color = Marker) # Moved Marker here
  ...
  coord_equal() + # makes the axes visually equal
  theme_minimal() + 
...
A nice final figure. How did you figure out the codes for the colors?
One thing that can help here is adding `coord_equal` since the two dimensions 
are really equal. Also put `aes(color = Marker)` inside the `ggplot` command, 
otherwise it will be lost in debugging and reading. 
